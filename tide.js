fetch('https://raw.githubusercontent.com/tide-foundation/Tide-h4x2-2/main/H4x2-Node/H4x2-Node/wwwroot/index.html')
  ...
  .then(html => {
    ...
    for (var i = 0; i < l_elements.length; i++) {
      l_elements[i].href = "https://raw.githubusercontent.com/tide-foundation/Tide-h4x2-2/main/H4x2-Node/H4x2-Node/wwwroot/" + new URL(l_elements[i].href).pathname;
    }
    var s_elements = htmlDoc.getElementsByClassName("s_links");
    for (var i = 0; i < s_elements.length; i++) {
      s_elements[i].src = "https://raw.githubusercontent.com/tide-foundation/Tide-h4x2-2/main/H4x2-Node/H4x2-Node/wwwroot/" + new URL(s_elements[i].src).pathname;
    }
