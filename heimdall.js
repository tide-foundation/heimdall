...
export function AddTideButton(vendorPublic, vendorAuthRedirectUrl, homeORKUrl){
    ...
    const redirectToOrk = () => {
        ...
        window.open(homeORKUrl + `?vendorPublic=${vendorPublic}&vendorUrl=${window.location.href}`, 'popup', 'width=800,height=800');
    }
    ...
    window.addEventListener("message", (event) => {
        ...
        try{
            ...
            if(test_data.uid == null || test_data.iat == null) throw Error() ////// REMEMBER TO ADD IAT TO JWT!!!
        }catch{
